  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="navbar py-4">
          <div className="flex-1">
            <NavLink to="/" className="group flex items-center gap-2">
              ...
              <span className="lg:text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
        ...
        {/* Mobile Menu */}
        <div
          className={`lg:hidden transition-all duration-300 ease-in-out mr-4 ${
            isMenuOpen
              ? "max-h-48 opacity-100"
              : "max-h-0 opacity-0 overflow-hidden"
          }`}
        >
          <ul className="menu menu-vertical px-1 gap-2 py-2">
            <li>
              <NavLink
                to="/"
                className={({ isActive }) =>
